...
real. Alongside that, I design and teach AI programs. I authored AUB's 8-week AI Starter Kit certificate,
co-authored the UAE AI Academy curriculum with Microsoft, and mentor and review code for SE Factory's AI
...
| **Customer-facing AI agent** | A policy assistant for a confidential insurance client, answering natural-language questions about their policies. I designed the prompt architecture, conversation flows, and grounding behaviour, and I own the backend infrastructure it runs on. |
